...
#6
txt=Label(text="You are Not a Member?",font=("Clibri",12,"italic"),bg="deep sky blue",fg="white").place(x="170",y="390")



#7
sgnup_btn = Button(text="Sign Up",width="14",font=("Calibri",10,"bold"),bg="deep sky blue",fg="white",command=shifting_form).place(x="347",y="390")
